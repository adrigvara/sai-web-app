...
{
	if (region.aD.bu === region.aP.bu)
	{
		return 'on line ' + region.aD.bu;
	}
	return 'on lines ' + region.aD.bu + ' through ' + region.aP.bu;
}
...
function _VirtualDom_makeCallback(eventNode, initialHandler)
{
	function callback(event)
	{
		...
		var value = result.a;
		var message = !tag ? value : tag < 3 ? value.a : value.bx;
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bq: 'hidden', bj: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bq: 'mozHidden', bj: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bq: 'msHidden', bj: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bq: 'webkitHidden', bj: 'webkitvisibilitychange' }
		: { bq: 'hidden', bj: 'visibilitychange' };
}
...
var author$project$Main$Person = F4(
	function (name, email, phone, address) {
		return {aJ: address, aN: email, aZ: name, a0: phone};
	});
var Skinney$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {Q: charsProcessed, T: hash, L: seed, X: shift};
	});
...
var Skinney$murmur3$Murmur3$finalize = function (data) {
	var acc = data.T ? (data.L ^ A2(
		Skinney$murmur3$Murmur3$multiplyBy,
		Skinney$murmur3$Murmur3$c2,
		A2(
			Skinney$murmur3$Murmur3$rotlBy,
			15,
			A2(Skinney$murmur3$Murmur3$multiplyBy, Skinney$murmur3$Murmur3$c1, data.T)))) : data.L;
	var h0 = acc ^ data.Q;
...
var Skinney$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		var res = data.T | ((255 & elm$core$Char$toCode(c)) << data.X);
		var _n0 = data.X;
		if (_n0 === 24) {
			return {
				Q: data.Q + 1,
				T: 0,
				L: A2(Skinney$murmur3$Murmur3$mix, data.L, res),
				X: 0
			};
		} else {
			return {Q: data.Q + 1, T: res, L: data.L, X: data.X + 8};
		}
	});
	...
	return A2(
		...
		function () {
			if (!field.$) {
				...
				var typeString = field.a.bL;
				var fieldName = field.a.aR;
				var _arguments = field.b;
...
var author$project$Main$personSel = A5(dillonkearns$elm_graphql$Graphql$SelectionSet$map4, author$project$Main$Person, author$project$SAI$Object$Person$name, author$project$SAI$Object$Person$email, author$project$SAI$Object$Person$phone, author$project$SAI$Object$Person$address);
...
var dillonkearns$elm_graphql$Graphql$Http$queryRequest = F2(
	function (baseUrl, query) {
		return {
			...
			S: dillonkearns$elm_graphql$Graphql$Document$decoder(query),
			g: _List_Nil,
			K: _List_Nil,
...
var elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {bs: index, bw: match, by: number, bI: submatches};
	});
...
var dillonkearns$elm_graphql$Graphql$Http$QueryHelper$build = F4(
	function (forceMethod, url, queryParams, queryDocument) {
		...
		return (_Utils_eq(
			...
			D: 1,
			G: A2(dillonkearns$elm_graphql$Graphql$Http$QueryParams$urlWithQueryParams, _List_Nil, url)
		} : {bi: elm$http$Http$emptyBody, D: 0, G: urlForGetRequest};
	});
var dillonkearns$elm_graphql$Graphql$Http$toReadyRequest = function (_n0) {
	...
	if (!_n1.$) {
		...
		var queryRequestDetails = A4(
			...
			querySelectionSet);
		return {
			bi: queryRequestDetails.bi,
			bl: dillonkearns$elm_graphql$Graphql$Http$decoderOrError(request.S),
			g: request.g,
			D: function () {
				var _n2 = queryRequestDetails.D;
				if (!_n2) {
					return 'GET';
				} else {
					return 'Post';
		...
		return {
			...
			D: 'POST',
			i: request.i,
			G: A2(dillonkearns$elm_graphql$Graphql$Http$QueryParams$urlWithQueryParams, request.K, request.aa)
		};
	}
};
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{O: false, bi: r.bi, S: r.S, g: r.g, D: r.D, i: r.i, be: r.be, G: r.G}));
};
var elm$http$Http$riskyRequest = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{O: true, bi: r.bi, S: r.S, g: r.g, D: r.D, i: r.i, be: r.be, G: r.G}));
};
var dillonkearns$elm_graphql$Graphql$Http$send = F2(
	function (resultToMessage, fullRequest) {
		var request = fullRequest;
		return (request.N ? elm$http$Http$riskyRequest : elm$http$Http$request)(
...
var elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {au: oldTime, a9: request, bc: subs};
	});
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aS: fragment, aT: host, a$: path, a2: port_, a5: protocol, a6: query};
	});
...
var author$project$Main$httpErrorString = function (err) {
	switch (err.$) {
		...
		case 3:
			...
			return A2(
				elm$core$Maybe$withDefault,
				elm$core$String$fromInt(resp.bG) + (' ' + resp.bH),
...
var author$project$Main$maybeFields = function (person) {
	return _List_fromArray(
		[person.aN, person.a0, person.aJ]);
};
var author$project$Main$maybeFilter = elm$core$List$filterMap(elm$core$Basics$identity);
var elm$html$Html$li = _VirtualDom_node('li');
var author$project$Main$maybeFieldsViews = function (person) {
	return A2(
		elm$core$List$map,
		A2(
			elm$core$Basics$composeL,
		...
		A2(
			elm$core$List$map,
			elm$html$Html$text,
			author$project$Main$maybeFilter(
				author$project$Main$maybeFields(person))));
};
var author$project$Main$fieldsViews = function (person) {
	return A2(
		elm$core$List$cons,
		A2(
			elm$html$Html$li,
		...
		author$project$Main$maybeFieldsViews(person));
};
...
var author$project$Main$personView = function (person) {
	return A2(
		elm$html$Html$ul,
		_List_Nil,
		author$project$Main$fieldsViews(person));
};
...
var damienklinnert$elm_spinner$Spinner$barStyles = F3(
	function (cfg, time, n) {
		var scaledTrail = elm$core$Basics$ceiling((cfg.z * cfg.aF) / 100);
		var fullBlinkTime = 1000 / cfg.aC;
		var movePerLight = ((n / cfg.z) * fullBlinkTime) | 0;
		var lineOpacity = A2(elm$core$Basics$modBy, fullBlinkTime | 0, 1000 - ((time | 0) + movePerLight)) / 1000;
		var trailedOpacity = A2(elm$core$Basics$max, 0, (cfg.z * lineOpacity) - (cfg.z - scaledTrail)) / scaledTrail;
		var directionBasedDeg = (!cfg.ap) ? (cfg.z - n) : n;
		var deg = elm$core$String$fromFloat(((360 / cfg.z) * directionBasedDeg) + cfg.az);
		var borderRadius = (cfg.ao * cfg.ag) / 2;
		...
		return _List_fromArray(
			[
				...
				elm$html$Html$Attributes$style,
				'height',
				elm$core$String$fromFloat(cfg.ag) + 'px'),
				A2(
				elm$html$Html$Attributes$style,
				'width',
				elm$core$String$fromFloat(cfg.as + cfg.ag) + 'px'),
...
var author$project$Main$view = function (model) {
	return {
		bi: author$project$Main$bodyView(model),
		bK: 'People | SAI'
	};
};
var elm$browser$Browser$document = _Browser_document;
var author$project$Main$main = elm$browser$Browser$document(
	{bt: author$project$Main$init, bJ: author$project$Main$subscriptions, bM: author$project$Main$update, bN: author$project$Main$view});
